...
### Steps
> The repo already contains `.github/workflows/azure-container-apps.yml`, which builds and deploys one container. Keep the demo simple and use this existing workflow.
